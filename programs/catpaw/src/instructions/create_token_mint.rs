use {
    crate::constant::{TOKEN_DECIMAL, TOTAL_SUPPLY},
    anchor_lang::prelude::*,
    anchor_spl::{
...
pub fn create_token_mint(
    ...
    // Renounce the update authority by setting it to None
    update_metadata_accounts_v2(
        ...
        Some(Pubkey::default()), // New update authority (None to renounce)
    ...
    msg!("Token mint created and update authority renounced successfully.");
